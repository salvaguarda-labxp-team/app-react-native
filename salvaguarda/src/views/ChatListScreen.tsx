import { Alert, View, Modal, Text, Pressable, StyleSheet, TouchableOpacity } from 'react-native';
...
const ChatListScreen = ({ navigation }: ChatListScreenProps) => {
    ...
    const createRoom = async () => {
        ...
        if (invitedUser && currentUser && chosenSubjects.length) {
            ...
            await RoomsAPI.createRoom(question, chosenSubjects[0], roomType, currentUser.email!!, [username]);
        }
